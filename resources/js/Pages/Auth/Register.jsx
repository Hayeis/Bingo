...
export default function Register() {
    ...
    return (
        <GuestLayout>
            <Head title="Register" />
            {/* Main - Register */}
            <h1 className="font-pixel text-[40px] text-[#301014] 
                            tracking-[10%] drop-shadow-[1px_0_0_#000] pl-5">REGISTER</h1>
            <p className="font-formal text-[14px] pl-6 pt-2 px-1 tracking-[10%]">Create an account to get started</p>
            <form onSubmit={submit}>
                <div className="relative mt-4 ml-5 ">
                    ...
                    <TextInput
                        ...
                        name="email"
                        value={data.email}
                        className="mt-1 block w-full bg-[#D9D9D9] !rounded-[10px] font-formal tracking-[10%]"
                        autoComplete="username"
                        onChange={(e) => setData('email', e.target.value)}
                        required
                    />
                    {/* icon mail */}
                    <div className="absolute right-3 top-1/2 -translate-y-1/2 mt-3 mr-1">
                ...
                <div className="mt-8 item-center justify-center flex">
                    <PrimaryButton className="ms-4 w-full !bg-[#51291E] hover:!bg-[#501a21] rounded-[13px] font-pixel_2 h-[42px] justify-center text-[22px] tracking-[10%]" 
                                   disabled={processing}>
                        Register
                    </PrimaryButton>
                </div>
                ...
                >
                    ...
                    <div className="mt-3 flex items-center justify-center">
                        <span className="font-formal">Already have an account? </span>
                        <Link 
                            href={route('login')}
                            className=" text-[#79B791] ms-1 hover:text-blue-800 hover:underline focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 font-formal"
                        >Log in here
                        </Link>
                    </div>
            </form>
