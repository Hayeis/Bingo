        ...
        <GuestLayout>
            ...
            <form onSubmit={submit}>
                <div className="relative mt-7 ml-5">
                    <InputLabel htmlFor="email" value="Email" className="font-formal" />
                    <TextInput
                        id="email"
                        type="email"
                        name="email"
                ...
                <div className="relative mt-3 ml-5">
                    ...
                    />
                    {/* icon password */}
                    <div className="absolute right-3 top-1/2 translate-y-1/3 mb-2 mr-1">
                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="flex justify-between item-center mt-5 ml-6">
                    ...
                    {canResetPassword && (
                        <Link
                            ...
                            className="rounded-md text-sm text-[#79B791] underline
                                        focus:outline-none focus:ring-2 focus:ring-indigo-500 
                                        focus:ring-offset-2 font-formal tracking-[10%]"
                        >
                ...
                <div className="mt-8 flex items-center justify-end">
                    <PrimaryButton className="w-full ml-5 rounded-[13px] font-pixel_2 h-[42px] 
                                            bg-[#51291E] hover:!bg-[#501a21] justify-center text-[23px]" disabled={processing}>
                        Log in
                    </PrimaryButton>
                </div>
                {/* garis */}
                <div className="relative flex py-5 items-center w-[332px] mx-auto">
                    <div className="flex-grow border-t border-gray-400"></div>
                    <span className="flex-shrink mx-4 text-gray-400 font-formal text-sm">OR</span>
                    <div className="flex-grow border-t border-gray-400"></div>
                </div>
                {/* Login with google */}
                <div className="mt-2 ml-2 w-full flex relative item-center justify-center">
                    <PrimaryButton className="hover:!bg-[#AAD1B4] bg-[#AAD1B4] rounded-[33px] font-[14px] !text-black w-full justify-center h-[67px] border-black"> 
                        <svg className="absolute left-8 w-10 h-10" xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 48 48" width="48px" height="48px"><path fill="#FFC107" d="M43.611,20.083H42V20H24v8h11.303c-1.649,4.657-6.08,8-11.303,8c-6.627,0-12-5.373-12-12c0-6.627,5.373-12,12-12c3.059,0,5.842,1.154,7.961,3.039l5.657-5.657C34.046,6.053,29.268,4,24,4C12.955,4,4,12.955,4,24c0,11.045,8.955,20,20,20c11.045,0,20-8.955,20-20C44,22.659,43.862,21.35,43.611,20.083z"/><path fill="#FF3D00" d="M6.306,14.691l6.571,4.819C14.655,15.108,18.961,12,24,12c3.059,0,5.842,1.154,7.961,3.039l5.657-5.657C34.046,6.053,29.268,4,24,4C16.318,4,9.656,8.337,6.306,14.691z"/><path fill="#4CAF50" d="M24,44c5.166,0,9.86-1.977,13.409-5.192l-6.19-5.238C29.211,35.091,26.715,36,24,36c-5.202,0-9.619-3.317-11.283-7.946l-6.522,5.025C9.505,39.556,16.227,44,24,44z"/><path fill="#1976D2" d="M43.611,20.083H42V20H24v8h11.303c-0.792,2.237-2.231,4.166-4.087,5.571c0.001-0.001,0.002-0.001,0.003-0.002l6.19,5.238C36.971,39.205,44,34,44,24C44,22.659,43.862,21.35,43.611,20.083z"/></svg>
                        <span className="font-formal ml-5">Continue with Google</span>
                    </PrimaryButton>
                </div>
            </form>
        </GuestLayout>
